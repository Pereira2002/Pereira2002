...
### 📦 VehixControl — Sistema de logística y transporte
> Plataforma web completa para gestión de flota, inventario y mantenimiento.

- 🔐 Autenticación con roles (registro, login, recuperación de contraseña)
- 🚛 CRUDs de flota, proveedores e inventario
- 📊 Dashboards con gráficos y consumo de combustible por vehículo
- 📄 Reportes en PDF y alertas en tiempo real
...
### 🎫 Tasklcosoft — Gestión de tickets internos
> App para soporte y operación interna con comunicación en vivo.

- 🔒 Rutas públicas/privadas + control por roles
- 🗂️ CRUD de tareas, usuarios, empresas y licencias
